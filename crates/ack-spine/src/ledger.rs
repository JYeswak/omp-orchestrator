...
//!
//! FILE OWNERSHIP: this file is assigned to AmberGate (%1408) per the
//! orchestrator's single-writer-per-file assignment. The other slices:
//!   ack.rs          <- SilverWolf (%1409) — read-back detector
//!   authorities.rs  <- BlueLantern (%1414) — three-authority separation
//!   lib.rs          <- ORCHESTRATOR (pane 1) — mod lines ONLY
